<?php $champs_customs = get_fields(); ?>
<div class="col-lg-2 col-6 icone_logo_header">
    <a href="<?php echo get_site_url('/'); ?>">
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 223.9 43.43">
            ...
            <path class="cls-1" d="M3.44,9.12,33.36,17A111.72,111.72,0,0,1,138,10.48" transform="translate(0.33 0.5)" />
